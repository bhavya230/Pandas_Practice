...
print(df3)
df3=pd.read_csv(StringIO(data3),index_col='index') # or give the index no 
print(df3)

# another example of index_cols-- when because of some none values issues are caused 

data4 =('a,b,c\n'
        '4,apple,bat,\n'
        '8,orange,cow,')

print(pd.read_csv(StringIO(data4)))
print(pd.read_csv(StringIO(data4),index_col=False))
